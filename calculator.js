...
buttons.forEach((button) => {
    button.addEventListener("click", () => {
        ...
        // if "clear" key is hit
            ...
            num2 = "";
            operator = null;
            document.querySelector("input#display").value = 0;
        }
    })
})
